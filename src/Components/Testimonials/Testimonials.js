...
const Testimonials = () => {
  ...
  return (
    <div id="testimonials">
      <div data-aos="fade-up" className="testimonial-div">
        ...
        <h1
          data-aos="fade-up"
          className="testimonial-h1 text-white text-center fw-bolder mt-5"
        >
          Testimonials
        </h1>
          ...
          <div className="text-center">
            <div className="pb-5 testimonial-p">
              <p className="pt-3 px-2">
                ...
                aut consequatur illo animi optio exercitationem doloribus
                eligendi iusto atque repudiandae. Distinctio.
